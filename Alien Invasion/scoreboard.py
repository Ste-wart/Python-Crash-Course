...
class ScoreBoard:
    ...
    def prep_score(self):
        ...
        score_str = f"S:{rounded_score:,}"
        self.score_img = self.font.render(
            score_str, True, self.text_color, self.settings.bg_colour)
    ...
    def prep_high_score(self):
        ...
        high_score_str = f"HS:{high_score:,}"
        self.high_score_image = self.font.render(
            high_score_str, True, self.text_color, self.settings.bg_colour)
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render(
            level_str, True, self.text_color, self.settings.bg_colour)
